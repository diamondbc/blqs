...
public class Decompression {
    ...
    public static void main(String[] args) {
        File jarFile = new File("/Users/diamondbc/soft/repository/com/iwdnb/test-sdk/1.0.0-SNAPSHOT/test-sdk-1.0.0-SNAPSHOT.jar");
        File targetDir = new File("/Users/diamondbc/soft/repository/com/iwdnb/test-sdk/1.0.0-SNAPSHOT/test-sdk-1.0.0-SNAPSHOT");
        try {
