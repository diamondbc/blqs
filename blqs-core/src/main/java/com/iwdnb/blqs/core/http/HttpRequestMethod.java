...
public class HttpRequestMethod {
    ...
    /**
     * Creates a new HTTP method with the specified name. You will not need to create a new method unless you are
     * implementing a protocol derived from HTTP
     */
    ...
    public static class Serializer extends JsonSerializer<HttpRequestMethod> {
        ...
        @Override
        public void serialize(HttpRequestMethod value, JsonGenerator gen,
    ...
    public static class Deserializer extends JsonDeserializer<HttpRequestMethod> {
        ...
        @Override
        public HttpRequestMethod deserialize(JsonParser p, DeserializationContext ctxt) throws IOException,
