...
public class Validations {
    ...
    public static final Set<String> Names        = Sets.newHashSet(NULL, NOT_BLANK, NOT_EMPTY, NOT_NULL, ASSERT_TRUE,
                                                                   ASSERT_FALSE, MIN, MAX, SIZE, EMAIL);
