...
public class HttpResponseStatus {
    ...
    /**
     * Equality of {@link HttpResponseStatus} only depends on {@link #code()}. The reason phrase is not considered for
     * equality.
     */
    @Override
    ...
    public String toString() {
        return new StringBuilder(reasonPhrase.length() + 4).append(code).append(' ').append(reasonPhrase).toString();
    }

    public static class Serializer extends JsonSerializer<HttpResponseStatus> {

        @Override
        public void serialize(HttpResponseStatus httpResponseStatus, JsonGenerator jsonGenerator,
    ...
    public static class Deserializer extends JsonDeserializer<HttpResponseStatus> {
        ...
        @Override
        public HttpResponseStatus deserialize(JsonParser jsonParser,
