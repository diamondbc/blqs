...
import com.iwdnb.blqs.core.resolver.ast.Tag;
import com.iwdnb.blqs.core.resolver.ast.Tags;
import com.iwdnb.blqs.core.schema.Appendix;
...
public abstract class NodeVisitor extends VoidVisitorAdapter<Node> {
    ...
    /**
     * 一个java文件是一个CompilationUnit 判断是否为一个Spring、JFinal环境
     * 
     * @param cu
     * @return
     */
