...
public class Fields {
    ...
    public static List<Element> getConstants(ClassOrInterfaceDeclaration declaration) {
        ...
        for (FieldDeclaration field : declaration.getFields()) {
            if (field.isStatic() && field.isPublic() && field.isFinal()) {
                ...
                elements.add(new Element(variable.getNameAsString(), value, description, null, null));
            }
        }
